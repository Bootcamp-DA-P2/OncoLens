...
(function () {
  ...
  const TUMOR_TYPES = [
    { code: 'BRCA', gene: 'ESR1', pdbId: '1A52', color: 0x1652f0, zoom: 1.5 },
    { code: 'KIRC', gene: 'VHL',  pdbId: '1VCB', color: 0x2c7be5, zoom: 1.5 },
    { code: 'LUAD', gene: 'EGFR', pdbId: '1M17', color: 0x14a6b8, zoom: 1.8 },
    { code: 'PRAD', gene: 'AR',   pdbId: '1E3G', color: 0x0e8f8a, zoom: 1.2 },
    { code: 'COAD', gene: 'KRAS', pdbId: '5P21', color: 0x6b5ce0, zoom: 1.4 },
  ];
